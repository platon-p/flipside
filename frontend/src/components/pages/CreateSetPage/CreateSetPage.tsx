...
export function CreateSetPage() {
    ...
    return (<div><div className="header">
        ...
        <div className="input-holder">
            <Input className='set-value' value={title} onInput={(e) => setTitle(e.currentTarget.value)} placeholder="название" />
            <div className="line"></div>
            <Input className='set-value' value={slug} onInput={(e) => setSlug(e.currentTarget.value)} placeholder="slug" />
            <div className="line"></div>
